...
/** @var app\modules\pos\models\PaymentMethodSearch $searchModel */
    ...
    <div class="row-group-form">
        <div class="row">
            <?php $form = ActiveForm::begin([
                'method' => 'get',
                'action' => Url::to(['/pos/payment-method/index']),
                'options' => ['class' => 'row'],
            ]); ?>
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="<?= Url::to('/pos/payment-method/create') ?>" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item has-icon" href="<?= Url::to(['/pos/payment-method/view', 'id' => $row->id]) ?>">
                                                            <i class="feather-eye"></i> View
                                                        </a>
                                                        <a class="dropdown-item has-icon" href="<?= Url::to(['/pos/payment-method/update', 'id' => $row->id]) ?>">
                                                            <i class="feather-edit"></i> Update
                                                        </a>
                                                        <a class="dropdown-item has-icon delete-btn" href="#" data-url="<?= Url::to(['/pos/payment-method/delete', 'id' => $row->id]) ?>">
