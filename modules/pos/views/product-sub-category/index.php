...
/** @var app\modules\pos\models\rowSearch $searchModel */
...
<div class="product-sub-category-index">
    ...
    <div class="row-group-form">
        <div class="row">
            <form method="get" action="<?= Url::to(['/pos/product-sub-category/index']) ?>">
                <div class="row">

                    <div class="col-lg-10 col-md-6">
                        <div class="form-group">
                            <input type="text" name="rowSearch[name]" class="form-control" placeholder="Sub-Category Name ..." value="<?= Html::encode($searchModel->name) ?>">
                        </div>
                    </div>
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="<?= Url::to('/pos/product-sub-category/create') ?>" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item has-icon" href="<?= Url::to(['/pos/product-sub-category/view', 'id' => $row->id]) ?>">
                                                            <i class="feather-eye"></i> View
                                                        </a>
                                                        <a class="dropdown-item has-icon" href="<?= Url::to(['/pos/product-sub-category/update', 'id' => $row->id]) ?>">
                                                            <i class="feather-edit"></i> Update
                                                        </a>
                                                        <a class="dropdown-item has-icon delete-btn" href="#" data-url="<?= Url::to(['/pos/product-sub-category/delete', 'id' => $row->id]) ?>">
